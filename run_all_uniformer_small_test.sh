...
CFG=$BASE_DIR/configs/SLR/bench_uniformer_small/eval
WDIR=$BASE_DIR/workdir/uniformer_small
...
run_test "$CFG/uniformer_small_aslcitizen100_from_train64_test64.py" \
         "$WDIR/aslcitizen100/train_64" \
         "$WDIR/aslcitizen100/eval_from_train64_test64"

run_test "$CFG/uniformer_small_aslcitizen100_from_train256_test256.py" \
         "$WDIR/aslcitizen100/train_256" \
         "$WDIR/aslcitizen100/eval_from_train256_test256"

run_test "$CFG/uniformer_small_aslcitizen100_from_train256_test256bilinear.py" \
         "$WDIR/aslcitizen100/train_256" \
         "$WDIR/aslcitizen100/eval_from_train256_test256bilinear"

run_test "$CFG/uniformer_small_aslcitizen100_from_train256_testSR.py" \
         "$WDIR/aslcitizen100/train_256" \
         "$WDIR/aslcitizen100/eval_from_train256_testSR"

run_test "$CFG/uniformer_small_aslcitizen100_from_train64_lr1e-5_test64.py" \
         "$WDIR/aslcitizen100/train_64_lr1e-5" \
         "$WDIR/aslcitizen100/eval_from_train64_lr1e-5_test64"

run_test "$CFG/uniformer_small_aslcitizen100_from_train256_lr1e-5_test256.py" \
         "$WDIR/aslcitizen100/train_256_lr1e-5" \
         "$WDIR/aslcitizen100/eval_from_train256_lr1e-5_test256"

run_test "$CFG/uniformer_small_aslcitizen100_from_train256_lr1e-5_test256bilinear.py" \
         "$WDIR/aslcitizen100/train_256_lr1e-5" \
         "$WDIR/aslcitizen100/eval_from_train256_lr1e-5_test256bilinear"

run_test "$CFG/uniformer_small_aslcitizen100_from_train256_lr1e-5_testSR.py" \
         "$WDIR/aslcitizen100/train_256_lr1e-5" \
         "$WDIR/aslcitizen100/eval_from_train256_lr1e-5_testSR"

run_test "$CFG/uniformer_small_aslcitizen100_from_train64_lr1e-4_test64.py" \
         "$WDIR/aslcitizen100/train_64_lr1e-4" \
         "$WDIR/aslcitizen100/eval_from_train64_lr1e-4_test64"

run_test "$CFG/uniformer_small_aslcitizen100_from_train256_lr1e-4_test256.py" \
         "$WDIR/aslcitizen100/train_256_lr1e-4" \
         "$WDIR/aslcitizen100/eval_from_train256_lr1e-4_test256"

run_test "$CFG/uniformer_small_aslcitizen100_from_train256_lr1e-4_test256bilinear.py" \
         "$WDIR/aslcitizen100/train_256_lr1e-4" \
         "$WDIR/aslcitizen100/eval_from_train256_lr1e-4_test256bilinear"

run_test "$CFG/uniformer_small_aslcitizen100_from_train256_lr1e-4_testSR.py" \
         "$WDIR/aslcitizen100/train_256_lr1e-4" \
...
run_test "$CFG/uniformer_small_wlasl100_from_train64_test64.py" \
         "$WDIR/wlasl100/train_64" \
         "$WDIR/wlasl100/eval_from_train64_test64"

run_test "$CFG/uniformer_small_wlasl100_from_train256_test256.py" \
         "$WDIR/wlasl100/train_256" \
         "$WDIR/wlasl100/eval_from_train256_test256"

run_test "$CFG/uniformer_small_wlasl100_from_train256_test256bilinear.py" \
         "$WDIR/wlasl100/train_256" \
         "$WDIR/wlasl100/eval_from_train256_test256bilinear"

run_test "$CFG/uniformer_small_wlasl100_from_train256_testSR.py" \
         "$WDIR/wlasl100/train_256" \
         "$WDIR/wlasl100/eval_from_train256_testSR"

run_test "$CFG/uniformer_small_wlasl100_from_train64_lr1e-5_test64.py" \
         "$WDIR/wlasl100/train_64_lr1e-5" \
         "$WDIR/wlasl100/eval_from_train64_lr1e-5_test64"

run_test "$CFG/uniformer_small_wlasl100_from_train256_lr1e-5_test256.py" \
         "$WDIR/wlasl100/train_256_lr1e-5" \
         "$WDIR/wlasl100/eval_from_train256_lr1e-5_test256"

run_test "$CFG/uniformer_small_wlasl100_from_train256_lr1e-5_test256bilinear.py" \
         "$WDIR/wlasl100/train_256_lr1e-5" \
         "$WDIR/wlasl100/eval_from_train256_lr1e-5_test256bilinear"

run_test "$CFG/uniformer_small_wlasl100_from_train256_lr1e-5_testSR.py" \
         "$WDIR/wlasl100/train_256_lr1e-5" \
         "$WDIR/wlasl100/eval_from_train256_lr1e-5_testSR"

run_test "$CFG/uniformer_small_wlasl100_from_train64_lr1e-4_test64.py" \
         "$WDIR/wlasl100/train_64_lr1e-4" \
         "$WDIR/wlasl100/eval_from_train64_lr1e-4_test64"

run_test "$CFG/uniformer_small_wlasl100_from_train256_lr1e-4_test256.py" \
         "$WDIR/wlasl100/train_256_lr1e-4" \
         "$WDIR/wlasl100/eval_from_train256_lr1e-4_test256"

run_test "$CFG/uniformer_small_wlasl100_from_train256_lr1e-4_test256bilinear.py" \
         "$WDIR/wlasl100/train_256_lr1e-4" \
         "$WDIR/wlasl100/eval_from_train256_lr1e-4_test256bilinear"

run_test "$CFG/uniformer_small_wlasl100_from_train256_lr1e-4_testSR.py" \
         "$WDIR/wlasl100/train_256_lr1e-4" \
         "$WDIR/wlasl100/eval_from_train256_lr1e-4_testSR"

echo "All uniformer_small test runs completed."

...
model = dict(
    ...
    cls_head=dict(in_channels=1536, num_classes=100))

# dataset settings
dataset_type = 'VideoDataset'
dataset_root = '/arf/scratch/zgokce/data'
data_root = dataset_root + '/WLASL/train'
data_root_val = dataset_root + '/WLASL/val'
data_root_test = dataset_root + '/WLASL/test'
ann_file_train = dataset_root + '/WLASL/train_wlasl100_mm2.txt'
ann_file_val = dataset_root + '/WLASL/val_wlasl100_mm2.txt'
ann_file_test = dataset_root + '/WLASL/test_wlasl100_mm2.txt'

...
template_file = "/home/zeynep/Thesis/code/mmaction2/truba/script_slurm/aslcitizen100_256x256/swin_large/job_swin_large_aslcitizen100_256x256.slurm"
slurm_folder = "/home/zeynep/Thesis/code/mmaction2/truba/script_slurm/aslcitizen100_256x256/swin_large"
...
for exp in experiments:
	...
	# Çıkış dosya adı
	output_filename = f"{slurm_folder}/job_swin_large_aslcitizen100_256x256_{deney_ismi}.slurm"

	# Şablonu kopyala
	modified_content = template_content

	# 1. #SBATCH -J satırını güncelle
	old_j_line = "#SBATCH -J swin_large_aslcitizen100_256x256"
	new_j_line = f"#SBATCH -J swin_large_aslcitizen100_256x256_{deney_ismi}"

...
CONFIG="./configs/SLR/bench_swin/swin_aslcitizen100_train256.py"
RUN_DIR="/arf/scratch/zgokce/bench/swin/aslcitizen100/train_256"
...
# ── Inline test (test256 on train256 checkpoint) ───────────────────────────
EVAL_DIR="${RUN_DIR%/train_256}/eval_from_train256_test256"
mkdir -p "$EVAL_DIR"

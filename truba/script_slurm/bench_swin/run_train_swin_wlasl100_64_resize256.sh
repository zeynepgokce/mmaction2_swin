...
CONFIG="./configs/SLR/bench_swin/swin_wlasl100_train64_resize256.py"
RUN_DIR="/arf/scratch/zgokce/bench/swin/wlasl100/train_64_resize256"
...
# ── Inline test (test64 on train64 checkpoint) ─────────────────────────────
EVAL_DIR="${RUN_DIR%/train_64_resize256}/eval_from_train64_test64"
EVAL_CONFIG="./configs/SLR/bench_swin/eval/swin_wlasl100_from_train64_test64.py"
mkdir -p "$EVAL_DIR"

...
CONFIG="./configs/SLR/bench_swin_base/swin_aslcitizen100_train64_resize256.py"
RUN_DIR="/arf/scratch/zgokce/workdir/swin_base/aslcitizen100/train_64_resize256"
...
EVAL_CONFIG="./configs/SLR/bench_swin_base/eval/swin_aslcitizen100_from_train64_test64resized256.py"
mkdir -p "$EVAL_DIR"

...
#SBATCH -A zgokce
#SBATCH -J bench_train_swin_large_wlasl100_256_lr1e-4
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_swin_large/swin_large_wlasl100_train256_lr1e-4.py"
RUN_DIR="/arf/scratch/zgokce/workdir/swin_large/wlasl100/train_256_lr1e-4"

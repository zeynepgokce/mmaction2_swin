...
#SBATCH -A zgokce
#SBATCH -J bench_eval_uniformer_wlasl100_tr256_te64
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer/eval/uniformer_wlasl100_from_train256_test64.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/uniformer_v2/wlasl100/train_256"
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer_v2/wlasl100/eval_from_train256_test64"

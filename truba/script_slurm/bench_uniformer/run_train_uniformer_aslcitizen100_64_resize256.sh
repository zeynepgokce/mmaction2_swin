...
CONFIG="./configs/SLR/bench_uniformer/uniformer_aslcitizen100_train64_resize256.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer/aslcitizen100/train_64_resize256"
...
EVAL_CONFIG="./configs/SLR/bench_uniformer/eval/uniformer_aslcitizen100_from_train64_test64resized256.py"
mkdir -p "$EVAL_DIR"

...
#SBATCH -A zgokce
#SBATCH -J bench_eval_uniformer_v2_large_wlasl100_tr64_te64
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2_large/eval/uniformer_v2_large_wlasl100_from_train64_test64.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/uniformer_v2_large/wlasl100/train_64"

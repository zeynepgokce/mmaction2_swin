...
#SBATCH -A zgokce
#SBATCH -J bench_train_uniformer_v2_large_aslcitizen100_64
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2_large/uniformer_v2_large_aslcitizen100_train64.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer_v2_large/aslcitizen100/train_64"

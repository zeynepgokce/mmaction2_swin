...
#SBATCH -A zgokce
#SBATCH -J bench_train_uniformer_v2_large_wlasl100_64_lr1e-4
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2_large/uniformer_v2_large_wlasl100_train64_lr1e-4.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer_v2_large/wlasl100/train_64_lr1e-4"

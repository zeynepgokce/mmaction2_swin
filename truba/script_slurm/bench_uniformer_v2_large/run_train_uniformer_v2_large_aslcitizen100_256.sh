...
#SBATCH -A zgokce
#SBATCH -J train_univ2l_aslcitizen100_256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2_large/uniformer_v2_large_aslcitizen100_train256.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer_v2_large/aslcitizen100/train_256"
...
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer_v2_large/aslcitizen100/eval_from_train256_test256"
mkdir -p "$EVAL_DIR"

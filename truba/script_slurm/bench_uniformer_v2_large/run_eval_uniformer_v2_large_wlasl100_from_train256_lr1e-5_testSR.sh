...
#SBATCH -A zgokce
#SBATCH -J eval_univ2l_wlasl100_tr256_lr1e-5_testSR
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2_large/eval/uniformer_v2_large_wlasl100_from_train256_lr1e-5_testSR.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/uniformer_v2_large/wlasl100/train_256_lr1e-5"
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer_v2_large/wlasl100/eval_from_train256_lr1e-5_testSR"

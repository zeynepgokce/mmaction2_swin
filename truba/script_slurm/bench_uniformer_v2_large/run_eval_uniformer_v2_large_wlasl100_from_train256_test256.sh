...
#SBATCH -A zgokce
#SBATCH -J bench_eval_uniformer_v2_large_wlasl100_tr256_te256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2_large/eval/uniformer_v2_large_wlasl100_from_train256_test256.py"

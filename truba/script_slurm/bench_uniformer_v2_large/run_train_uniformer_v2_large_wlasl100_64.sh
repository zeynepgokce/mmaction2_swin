...
#SBATCH -A zgokce
#SBATCH -J train_univ2l_wlasl100_64
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2_large/uniformer_v2_large_wlasl100_train64.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer_v2_large/wlasl100/train_64"
...
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer_v2_large/wlasl100/eval_from_train64_test64"
mkdir -p "$EVAL_DIR"

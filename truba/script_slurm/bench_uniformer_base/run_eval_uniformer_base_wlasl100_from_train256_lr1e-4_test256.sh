...
#SBATCH -A zgokce
#SBATCH -J bench_eval_uniformer_base_wlasl100_tr256_lr4_te256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_base/eval/uniformer_base_wlasl100_from_train256_lr1e-4_test256.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/uniformer_base/wlasl100/train_256_lr1e-4"
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer_base/wlasl100/eval_from_train256_lr1e-4_test256"

...
#SBATCH -A zgokce
#SBATCH -J train_uniformer_base_aslcitizen100_256_lr1e-4
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_base/uniformer_base_aslcitizen100_train256_lr1e-4.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer_base/aslcitizen100/train_256_lr1e-4"

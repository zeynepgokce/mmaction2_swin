...
#SBATCH -A zgokce
#SBATCH -J train_uniformer_base_aslcitizen100_64
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_base/uniformer_base_aslcitizen100_train64.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer_base/aslcitizen100/train_64"

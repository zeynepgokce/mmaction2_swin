...
#SBATCH -A zgokce
#SBATCH -J train_uniformer_base_wlasl100_64_lr1e-5
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_base/uniformer_base_wlasl100_train64_lr1e-5.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer_base/wlasl100/train_64_lr1e-5"

...
#SBATCH -A zgokce
#SBATCH -J bench_eval_uniformer_base_aslcitizen100_tr256_te256bilinear
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_base/eval/uniformer_base_aslcitizen100_from_train256_test256bilinear.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/uniformer_base/aslcitizen100/train_256"
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer_base/aslcitizen100/eval_from_train256_test256bilinear"

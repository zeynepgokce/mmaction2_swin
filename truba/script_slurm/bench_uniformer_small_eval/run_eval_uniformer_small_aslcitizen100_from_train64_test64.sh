...
#SBATCH -A zgokce
#SBATCH -J eval_uniformer_small_aslc100_tr64_test64
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_small/eval/uniformer_small_aslcitizen100_from_train64_test64.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/uniformer_small/aslcitizen100/train_64"

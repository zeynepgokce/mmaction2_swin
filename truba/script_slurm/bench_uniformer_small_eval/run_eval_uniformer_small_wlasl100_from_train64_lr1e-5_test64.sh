...
#SBATCH -A zgokce
#SBATCH -J eval_uniformer_small_wlasl_tr64_lr1e-5_test64
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_small/eval/uniformer_small_wlasl100_from_train64_lr1e-5_test64.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/uniformer_small/wlasl100/train_64lr1e-5"

...
#SBATCH -A zgokce
#SBATCH -J eval_uniformer_small_wlasl_tr256_test256bilinear
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_small/eval/uniformer_small_wlasl100_from_train256_test256bilinear.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/uniformer_small/wlasl100/train_256"
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer_small/wlasl100/eval_from_train256_test256bilinear"

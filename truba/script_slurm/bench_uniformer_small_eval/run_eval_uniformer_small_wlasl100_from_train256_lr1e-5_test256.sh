...
#SBATCH -A zgokce
#SBATCH -J eval_us_wlasl_tr256_lr1e-5_test256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_small/eval/uniformer_small_wlasl100_from_train256_lr1e-5_test256.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/uniformer_small/wlasl100/train_256_lr1e-5"

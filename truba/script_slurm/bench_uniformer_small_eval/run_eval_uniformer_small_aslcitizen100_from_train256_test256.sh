...
#SBATCH -A zgokce
#SBATCH -J eval_uniformer_small_aslc100_tr256_test256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_small/eval/uniformer_small_aslcitizen100_from_train256_test256.py"

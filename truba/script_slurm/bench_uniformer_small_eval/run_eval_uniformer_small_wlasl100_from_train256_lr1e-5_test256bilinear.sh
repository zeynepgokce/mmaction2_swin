...
#SBATCH -A zgokce
#SBATCH -J eval_us_wlasl_tr256_lr1e-5_test256bilinear
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer_small/wlasl100/eval_from_train256_lr1e-5_test256bilinear"

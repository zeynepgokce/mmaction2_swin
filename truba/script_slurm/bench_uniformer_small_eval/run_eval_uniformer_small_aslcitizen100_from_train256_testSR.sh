...
#SBATCH -A zgokce
#SBATCH -J eval_uniformer_small_aslc100_tr256_testSR
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_small/eval/uniformer_small_aslcitizen100_from_train256_testSR.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/uniformer_small/aslcitizen100/train_256"
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer_small/aslcitizen100/eval_from_train256_testSR"

...
#SBATCH -A zgokce
#SBATCH -J bench_train_swin_base_aslcitizen100_256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_swin_base/swin_base_aslcitizen100_train256.py"
RUN_DIR="/arf/scratch/zgokce/workdir/swin_base/aslcitizen100/train_256"

...
#SBATCH -A zgokce
#SBATCH -J bench_eval_swin_base_wlasl100_tr256_teSR
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_swin_base/eval/swin_base_wlasl100_from_train256_testSR.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/swin_base/wlasl100/train_256"
EVAL_DIR="/arf/scratch/zgokce/workdir/swin_base/wlasl100/eval_from_train256_testSR"

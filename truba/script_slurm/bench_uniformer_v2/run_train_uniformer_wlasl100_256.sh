...
#SBATCH -A zgokce
#SBATCH -J bench_train_uniformer_wlasl100_256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2/uniformer_wlasl100_train256.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer_v2/wlasl100/train_256"

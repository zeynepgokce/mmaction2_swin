...
#SBATCH -A zgokce
#SBATCH -J bench_train_uniformer_aslcitizen100_64r256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2/uniformer_aslcitizen100_train64_resize256.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer_v2/aslcitizen100/train_64_resize256"
...
EVAL_CONFIG="./configs/SLR/bench_uniformer_v2/eval/uniformer_aslcitizen100_from_train64_test64resized256.py"
mkdir -p "$EVAL_DIR"

...
#SBATCH -A zgokce
#SBATCH -J bench_eval_uniformer_aslcitizen_tr64_te64
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2/eval/uniformer_aslcitizen100_from_train64_test64resized256.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/uniformer_v2/aslcitizen100/train_64_resize256"
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer_v2/aslcitizen100/eval_from_train64_test64resized256"
REPORT_DIR="/arf/scratch/zgokce/workdir/uniformer_v2/aslcitizen100/reports"

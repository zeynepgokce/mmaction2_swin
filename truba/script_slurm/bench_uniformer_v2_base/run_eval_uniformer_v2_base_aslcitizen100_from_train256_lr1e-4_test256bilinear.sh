...
#SBATCH -A zgokce
#SBATCH -J bench_eval_uniformer_v2_base_aslcitizen100_tr256_lr4_te256bilinear
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2_base/eval/uniformer_v2_base_aslcitizen100_from_train256_lr1e-4_test256bilinear.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/uniformer_v2_base/aslcitizen100/train_256_lr1e-4"
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer_v2_base/aslcitizen100/eval_from_train256_lr1e-4_test256bilinear"

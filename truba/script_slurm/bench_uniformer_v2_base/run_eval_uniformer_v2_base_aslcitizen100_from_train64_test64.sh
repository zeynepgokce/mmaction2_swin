...
#SBATCH -A zgokce
#SBATCH -J bench_eval_uniformer_v2_base_aslcitizen100_tr64_te64
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2_base/eval/uniformer_v2_base_aslcitizen100_from_train64_test64.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/uniformer_v2_base/aslcitizen100/train_64"
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer_v2_base/aslcitizen100/eval_from_train64_test64"

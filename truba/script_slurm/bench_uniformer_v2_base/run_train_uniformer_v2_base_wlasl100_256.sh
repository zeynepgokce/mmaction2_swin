...
#SBATCH -A zgokce
#SBATCH -J train_uniformer_v2_base_wlasl100_256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2_base/uniformer_v2_base_wlasl100_train256.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer_v2_base/wlasl100/train_256"

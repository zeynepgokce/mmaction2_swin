...
#SBATCH -A zgokce
#SBATCH -J eval_uniformer_v2_base_aslcitizen100_tr256_lr1e-5_test256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2_base/eval/uniformer_v2_base_aslcitizen100_from_train256_lr1e-5_test256.py"

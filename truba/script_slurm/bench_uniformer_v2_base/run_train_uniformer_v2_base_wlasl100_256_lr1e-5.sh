...
#SBATCH -A zgokce
#SBATCH -J train_uniformer_v2_base_wlasl100_256_lr1e-5
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_v2_base/uniformer_v2_base_wlasl100_train256_lr1e-5.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer_v2_base/wlasl100/train_256_lr1e-5"

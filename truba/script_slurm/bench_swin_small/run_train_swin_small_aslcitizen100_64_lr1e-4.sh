...
#SBATCH -A zgokce
#SBATCH -J bench_train_swin_small_aslcitizen100_64_lr1e-4
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_swin_small/swin_small_aslcitizen100_train64_lr1e-4.py"
RUN_DIR="/arf/scratch/zgokce/workdir/swin_small/aslcitizen100/train_64_lr1e-4"

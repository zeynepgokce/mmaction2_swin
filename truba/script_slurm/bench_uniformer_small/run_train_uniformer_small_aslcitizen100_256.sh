...
#SBATCH -A zgokce
#SBATCH -J train_uniformer_small_aslcitizen100_256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_small/uniformer_small_aslcitizen100_train256.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer_small/aslcitizen100/train_256"
...
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer_small/aslcitizen100/eval_from_train256_test256"
mkdir -p "$EVAL_DIR"

...
#SBATCH -A zgokce
#SBATCH -J train_uniformer_small_aslcitizen100_256_lr1e-4
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_small/uniformer_small_aslcitizen100_train256_lr1e-4.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer_small/aslcitizen100/train_256_lr1e-4"
REPORT_DIR="/arf/scratch/zgokce/workdir/uniformer_small/aslcitizen100/reports"

echo "==> CONFIG   : $CONFIG"
echo "==> WORK DIR : $RUN_DIR"

mkdir -p "$RUN_DIR" "$REPORT_DIR" /arf/scratch/zgokce/logs/uniformer_small
...
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer_small/aslcitizen100/eval_from_train256_lr1e-4_test256"
mkdir -p "$EVAL_DIR"

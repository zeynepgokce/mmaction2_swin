...
#SBATCH -A zgokce
#SBATCH -J train_uniformer_small_aslcitizen100_256_lr1e-5
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_uniformer_small/uniformer_small_aslcitizen100_train256_lr1e-5.py"
RUN_DIR="/arf/scratch/zgokce/workdir/uniformer_small/aslcitizen100/train_256_lr1e-5"

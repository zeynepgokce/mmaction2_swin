...
#SBATCH -A zgokce
#SBATCH -J bench_eval_uniformer_wlasl100_tr64_te64
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/uniformer/wlasl100/train_64_resize256"
EVAL_DIR="/arf/scratch/zgokce/workdir/uniformer/wlasl100/eval_from_train64_test64resized256"

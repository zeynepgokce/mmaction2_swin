...
#SBATCH -A zgokce
#SBATCH -J bench_train_swin_wlasl100_64r256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_swin_base/swin_wlasl100_train64_resize256.py"
RUN_DIR="/arf/scratch/zgokce/workdir/swin_base/wlasl100/train_64_resize256"
REPORT_DIR="/arf/scratch/zgokce/workdir/swin_base/wlasl100/reports"

echo "==> CONFIG   : $CONFIG"
echo "==> WORK DIR : $RUN_DIR"

mkdir -p "$RUN_DIR" "$REPORT_DIR" /arf/scratch/zgokce/logs/swin_base
...
EVAL_DIR="${RUN_DIR}/eval_from_train64_test64resized256"
EVAL_CONFIG="./configs/SLR/bench_swin_base/eval/swin_wlasl100_from_train64_test64resized256.py"
mkdir -p "$EVAL_DIR"

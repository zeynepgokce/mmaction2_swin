...
#SBATCH -A zgokce
#SBATCH -J bench_eval_swin_wlasl100_tr64_te64
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_swin_base/eval/swin_wlasl100_from_train64_test64resized256.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/swin_base/wlasl100/train_64_resize256"
EVAL_DIR="/arf/scratch/zgokce/workdir/swin_base/wlasl100/eval_from_train64_test64resized256"

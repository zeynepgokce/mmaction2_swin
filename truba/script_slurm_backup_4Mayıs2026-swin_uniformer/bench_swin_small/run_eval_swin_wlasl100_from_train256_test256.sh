...
#SBATCH -A zgokce
#SBATCH -J bench_eval_swin_small_wlasl100_tr256_te256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_swin_small/eval/swin_wlasl100_from_train256_test256.py"
TRAIN_WORKDIR="/arf/scratch/zgokce/workdir/swin_small/wlasl100/train_256"
EVAL_DIR="/arf/scratch/zgokce/workdir/swin_small/wlasl100/eval_from_train256_test256"

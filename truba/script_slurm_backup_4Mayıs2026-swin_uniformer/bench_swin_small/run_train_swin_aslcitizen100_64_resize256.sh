...
#SBATCH -A zgokce
#SBATCH -J bench_train_swin_small_aslcitizen100_64r256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_swin_small/swin_aslcitizen100_train64_resize256.py"
RUN_DIR="/arf/scratch/zgokce/workdir/swin_small/aslcitizen100/train_64_resize256"
...
EVAL_CONFIG="./configs/SLR/bench_swin_small/eval/swin_aslcitizen100_from_train64_test64resized256.py"
mkdir -p "$EVAL_DIR"

...
template_file = "/home/zeynep/Thesis/code/mmaction2/truba/script_slurm/aslcitizen100_256x256/swin_base/job_swin_base_aslcitizenl100_256x256.slurm"
slurm_folder = "/home/zeynep/Thesis/code/mmaction2/truba/script_slurm/aslcitizen100_256x256/swin_base"
...
for exp in experiments:
	...
	# Çıkış dosya adı
	output_filename = f"{slurm_folder}/job_swin_base_aslcitizen100_256x256_{deney_ismi}.slurm"

	# Şablonu kopyala
	modified_content = template_content

	# 1. #SBATCH -J satırını güncelle
	old_j_line = "#SBATCH -J swin_base_aslcitizen100_256x256"
	new_j_line = f"#SBATCH -J swin_base_aslcitizen100_256x256_{deney_ismi}"

...
#SBATCH -A zgokce
#SBATCH -J bench_train_swin_tiny_wlasl100_64r256
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
CONFIG="./configs/SLR/bench_swin_tiny/swin_tiny_wlasl100_train64.py"
RUN_DIR="/arf/scratch/zgokce/workdir/swin_tiny/wlasl100/train_64"

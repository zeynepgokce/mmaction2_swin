...
template_file = "/home/zeynep/Thesis/code/mmaction2/truba/script_slurm/aslcitizen100_64x64/swin_small/job_swin_small_aslcitizen100_64x64.slurm"
slurm_folder = "/home/zeynep/Thesis/code/mmaction2/truba/script_slurm/aslcitizen100_64x64/swin_small"
...
for exp in experiments:
	...
	# Çıkış dosya adı
	output_filename = f"{slurm_folder}/job_swin_small_aslcitizen100_64x64_{deney_ismi}.slurm"

	# Şablonu kopyala
	modified_content = template_content

	# 1. #SBATCH -J satırını güncelle
	old_j_line = "#SBATCH -J swin_small_aslcitizen100_64x64"
	new_j_line = f"#SBATCH -J swin_small_aslcitizen100_64x64_{deney_ismi}"
